...
class Arr {
    ...
    public static function array_add($array, $key, $value) {
        if (is_null(static::array_get($array, $key))) {
            static::array_set($array, $key, $value);
        }
     ...
     * @return array
     */
    public static function array_build($array, $callback) {
        $results = array();
     ...
     * @return array
     */
    public static function array_sort($array, Closure $callback) {
